                ...
                <tbody>
                  <?php
                    ...
                    try{
                      ...
                      $stmt = $conn->prepare("SELECT g.*, p.name as program_name FROM company_stickers g LEFT JOIN programs p ON p.id=g.program_id WHERE 1");
                     }
                      $stmt->execute(['type'=>0]);
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>
                            <a href='#addnew' class='copy_photo' data-toggle='modal' data-image='".$row['image']."'><i class='fa fa-copy'></i>copy</a>
                              <img src='".$image."' height='30px' width='30px'>
                              <span class=''><a href='#edit_photo' class='photo' data-toggle='modal' data-id='".$row['id']."'><i class='fa fa-edit'></i>update image</a>
