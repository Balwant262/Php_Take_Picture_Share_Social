...
<div class="modal fade" id="addnew">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" action="stickers_add.php" enctype="multipart/form-data">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Add New Stickers</b></h4>
            </div>
            <div class="modal-body">
             
                <input type="hidden" class="userid" name="id">
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">Sticker Name</label>
                    ...
                    <div class="col-sm-9">
                        ...
                        <select class="form-control " name="alreay_imgae_name" id="alreay_check">
                            ...
                            <?php
                                ...
                                try{
                                  $stmt = $conn->prepare("SELECT * FROM company_stickers WHERE 1");
                                  $stmt->execute(['type'=>0]);
                                  foreach($stmt as $row){
                ...
                <div class="form-group" id="row_select_image">
                    <label for="photo" class="col-sm-3 control-label">Sticker Image</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Edit Sticker</b></h4>
            </div>
            <form class="form-horizontal" method="POST" action="stickers_edit.php">
            <div class="modal-body">
...
<div class="modal fade" id="edit_photo">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" action="stickers_photo.php" enctype="multipart/form-data">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
             <form class="form-horizontal" method="POST" action="stickers_delete.php">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
